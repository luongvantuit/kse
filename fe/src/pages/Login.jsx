                    ...
                    <div className="login-background">
                        ...
                        <div className='login-content'>
                            ...
                            <div className='btn-rectangle'>
                                <button onClick={handleSubmit} className='btn-login'>ĐĂNG NHẬP</button>
                            </div>
                            {forgot && (
                              <div className='error'>
                                <CloseIcon sx={{fontSize: '16px' }} className="error-icon"></CloseIcon>
                                
                                <span className="error-text"> Đăng nhập thất bại. Tài khoản hoặc Mật khẩu bị sai!</span>
                              </div>
                            )}
                        </div>
                    </div>
